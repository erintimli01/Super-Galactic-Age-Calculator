export default class Planet {
  constructor(age, mercuryAge, venusAge, marsAge, jupiterAge, pastAge, mercPast, venuPast, marPast, jupiPast, futureAge, mercFuture, venuFuture) {
    this.age = age;
...
//WIP
// mercuryFuture() {
//   let mercFuture = ((this.futureAge - this.age) /.24);
//   return mercFuture
//   }
